...
void dump_csv(){
  ...
  if (f != NULL){
    ...
    fprintf(f,"STORE,LOAD,CMP,ADD,SUB,MUL,UDIV,SDIV,UREM,SREM,FADD,FSUB,FMUL,FDIV,FCMP,AND,OR,XOR,BR\n");
    fprintf(f, "%llu,%llu,%llu,%llu,%llu,%llu,%llu,%llu,%llu,%llu,%llu,%llu,%llu,%llu,%llu,%llu,%llu,%llu,%llu\n", 
